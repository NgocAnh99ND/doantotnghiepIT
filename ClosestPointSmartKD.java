...
public class ClosestPointSmartKD {
    ...
    static Point kdNearest(KDNode node, Point target, Point best, double[] bestDist) {
        ...
        double axisDist = node.splitLat ? Math.abs(target.lat - node.p.lat) * 111000
    ...
    static List<Point> generateRoute10() {
        return Arrays.asList(
                new Point(21.090, 105.810),
                new Point(21.080, 105.820),
                new Point(21.070, 105.830),
                new Point(21.060, 105.830),
